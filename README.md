...
&nbsp;&nbsp;&nbsp;&nbsp;Para mencionar as características levantadas nos relatórios anteriores, de acordo com [4](https://www.altus.com.br/post/294/conheca-o-xp340-2c-clp-nexto-xpress-com-suporte-a-webserver), o CLP “possui 16 entradas digitais, 16 saídas digitais à Transistor, 5 entradas analógicas V/I, 2 entradas analógicas RTD (3 fios) e 4 saídas analógicas. Projetada para atender aos requisitos de ambientes altamente conectados, a solução conta com interfaces de comunicação Serial RS 485, CAN e USB, bem como suporte a uma ampla variedade de protocolos de comunicação, como MODBUS TCP Cliente/Servidor, OPC DA e OPC UA.” e também são levantadas funcionalidade de interação com a nuvem, evidenciando esse CLP como uma poderosa ferramenta para IoT.
</p>
